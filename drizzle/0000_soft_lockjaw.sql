...
CREATE TYPE "public"."plan" AS ENUM('free', 'credits', 'unlimited');--> statement-breakpoint
...
CREATE TYPE "public"."transaction_type" AS ENUM('purchase', 'usage', 'refund', 'subscription');--> statement-breakpoint
